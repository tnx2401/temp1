...
import classes from "./MatGoc.module.scss";
...
const MatGoc = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://determined-freedom-production.up.railway.app/api/v1/khoahoc/1"
      )
      .then((res) => {
        setCourse(res.data);
      })
    ...
    <div className={classes.container}>
      <div className={classes.hero_img}>
        ...
        <div className={classes.paragraph_00}>
          <h3>
            KHÓA IELTS CHO <br /> NGƯỜI MỚI BẮT ĐẦU
            <br /> &amp; NGƯỜI MẤT GỐC
          </h3>
        </div>
        <div className={classes.paragraph_01}>
          <h3>
            Lộ trình học CHỮA MẤT GỐC tại IELTS Fighter sẽ giúp bạn chinh phục
      ...
      <div className={classes.content}>
        ...
        >
          <div className={classes.wrapper}>
            <div className={classes.left}>
              <h1>
                Hãy để IELTS Fighter giúp bạn "TĂNG TỐC - ĐẠT 5.0-7.0+ IELTS"
                CHỈ SAU 1 KHÓA HỌC!
              </h1>
              <p>
                Với kinh nghiệm 6 năm đào tạo hàng nghìn học viên đạt 7.0 - 8.0
                IELTS, chúng tôi đã thiết kế một lộ trình CAM KÊT HẾT MẤT GỐC
                IELTS.
              </p>
            </div>
        ...
        <div
          ...
          id="context02"
        >
          <h1>Bạn muốn hướng tới mục tiêu nào ?</h1>
          <h2>
            Lộ trình học IELTS tại IELTS Fighter được chia theo các giai đoạn và
            level khác nhau. Tùy theo đầu vào và trình độ hướng tới mà các bạn
            lựa chọn khóa học, lớp học phù hợp bản thân.
          </h2>
