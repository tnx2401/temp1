...
import classes from "./Aim55.module.scss";
...
const Aim55 = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://determined-freedom-production.up.railway.app/api/v1/khoahoc/4"
      )
      .then((res) => {
        setCourse(res.data);
      });
        ...
        >
          <div className={classes.wrapper}>
            <div className={classes.left}>
              <h1>
                Hãy để IELTS Fighter giúp bạn "TĂNG TỐC - ĐẠT 5.5 IELTS" CHỈ SAU
                1 KHÓA HỌC!
              </h1>
              <p>
