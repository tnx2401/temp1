...
import classes from "./Aim75.module.scss";
...
const Aim75 = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://determined-freedom-production.up.railway.app/api/v1/khoahoc/6"
      )
      .then((res) => {
        setCourse(res.data);
  ...
  const teacher = [
    {
      ...
      skill: "8.0 IELTS",
      image:
        "https://w.ladicdn.com/s500x450/5b57f38472976020da8e5611/pham-dang-thuy-dung-20230925051233-tasgl.png",
      description: [
        "Cô tốt nghiệp loại Xuất sắc và Thạc sĩ Business Administration – Đại học Ngoại Thương Hà Nội​",
        "Đang theo học Thạc sĩ TESOL – Đại học Canberra Úc",
        "Kinh nghiệm giảng dạy: 7 năm",
        "Cô giáo nhiều năm kinh nghiệm, luôn tận tâm, giúp đỡ học viên.",
      ],
    },
    {
      id: 2,
      ...
      skill: "8.5 IELTS",
      image:
        "https://w.ladicdn.com/s500x450/5b57f38472976020da8e5611/thay-hoang-20230925051617-cpwwo.jpg",
      description: [
        "Thầy giáo tận tâm, luôn đem đến cho lớp học bầu không khí thoải mái, học tập sáng tạo và đầy đam mê.",
        "8.0 IELTS Speaking",
        "Kinh nghiệm giảng dạy: 5 năm",
        "Đào tạo nhiều bạn học viên điểm cao nhất khu vực miền Bắc.",
      ],
    },
    {
      id: 3,
      ...
      skill: "8.0 IELTS",
      image:
        "https://w.ladicdn.com/s500x450/5b57f38472976020da8e5611/nguyen-hoai-ngoc-20230925052527-9wbvh.png",
      description: [
        "Cô giáo tốt nghiệp loại Xuất sắc chuyên ngành Sư phạm Anh ĐH Sư phạm Hà Nội",
        "Kinh nghiệm giảng dạy: 2 năm",
        "Cô giáo với sự hài hước, thân thiện, tự nhiên , luôn biến những giờ học vui vẻ và hứng khởi để học tập tốt nhất!",
      ],
    },
    {
      id: 4,
      ...
      skill: "8.0 IELTS",
      image:
        "https://w.ladicdn.com/s500x450/5b57f38472976020da8e5611/thay-jim-2-20230925052118-xoft4.jpg",
      description: [
        "Thầy giáo thân thiện, sở hữu 9.0 Speaking, giọng mê ly",
        "Tốt nghiệp RMIT loại Giỏi 3.4/4.0",
        "Học bổng RMIT 2014",
        "Giáo viên nhiều năm liền, cống hiến tại IELTS Fighter.",
      ],
    },
  ];

  const feedback_videos = [
    "https://www.youtube.com/embed/lHK77sJunwM?si=wnwQ5Ix5vr0jNQFD",
    "https://www.youtube.com/embed/nc2LZsNg8Mc?si=9-uAGXvaFmqyDQLw",
  ];
  const feedback_cards = [
    {
      id: 1,
      title: "Quốc Dũng - 7.0 IELTS",
      job: "Học sinh lớp 9",
      image:
        "https://w.ladicdn.com/s550x550/5b57f38472976020da8e5611/hanh-trinh-thi-ielts-7-0-tu-lop-9-1-20230925070422-nr5hd.jpg",
    ...
    {
      id: 2,
      title: "Linh Chi - 7.5 IELTS",
      job: "Học sinh lớp 12",
      image:
        "https://w.ladicdn.com/s550x550/5b57f38472976020da8e5611/hoc-sinh-ha-noi-hoc-ielts-1-kem-1-11-20230925070205-g7wkb.jpg",
      ...
      <div className={classes.content}>
        <div className={classes.context_00}>
          <div className={classes.left}>
            <button className={classes.btn_00} onClick={handleScroll}>
              Đăng kí ngay
            </button>
          </div>
        ...
        <div
          ...
          id="context_05"
        >
          <h1>Đội ngũ chiến binh nhiệt huyết</h1>
          <h2>
            Đội ngũ giáo viên IELTS giảng dạy tại IELTS Fighter đều là những
            chiến binh 8.0-8.5 IELTS, giàu nhiệt huyết và kinh nghiệm, sẵn sàng
            giúp bạn chinh phục điểm số cao như ý.
          </h2>
